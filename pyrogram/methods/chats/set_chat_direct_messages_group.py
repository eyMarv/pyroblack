    ...
    async def set_chat_direct_messages_group(
        ...
        Parameters:
            ...
            paid_message_star_count (``int``):
                The new number of Telegram Stars that must be paid for each message that is sent to the direct messages
                chat unless the sender is an administrator of the channel chat, 0-10000.

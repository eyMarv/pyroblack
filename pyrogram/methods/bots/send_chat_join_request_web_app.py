...
class SendChatJoinRequestWebApp:
    async def send_chat_join_request_web_app(
        ...
        """Process a received chat join request query by showing a Mini App to the user.

        Call :meth:`~pyrogram.Client.answer_chat_join_request_query` to resolve the join request
        query based on the user interaction with the Mini App.

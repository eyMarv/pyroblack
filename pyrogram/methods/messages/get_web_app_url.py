...
class GetWebAppUrl:
    async def get_web_app_url(
        ...
        """Return an HTTPS URL of a Web App to open from the side menu or web app buttons.
        ...
        Parameters:
            ...
            url (``str``, *optional*):
                The URL from a web app button, or None when the bot is opened from the side menu.

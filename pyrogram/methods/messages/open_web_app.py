...
class OpenWebApp:
    async def open_web_app(
        ...
        """Inform Telegram that a Web App is being opened from menus, URLs, or buttons.
        ...
        Parameters:
            ...
            url (``str``, *optional*):
                The URL from an inline keyboard button or menu button.

            message_thread_id (``int``, *optional*):
                If not None, the message thread identifier to which the message will be sent.

            direct_messages_topic_id (``int``, *optional*):
                If not None, unique identifier of the topic of channel direct messages chat to which
                the message will be sent.

            reply_parameters (:obj:`~pyrogram.types.ReplyParameters`, *optional*):
                Information about the message or story to be replied to in the message sent by the Web App.

...
class SendPaidMedia:
    async def send_paid_media(
        ...
        stars_amount: int | None = None,  # alias for star_count (pyroblack <= 2.7.2)
        ...
        if star_count is None:
            msg = "star_count (or stars_amount) is required"
            ...
            if isinstance(i, types.InputPaidMediaPhoto):
                ...
                if i.cover:
                    ...
                    if is_uploaded_file:
                        ...
                        video_cover_file = (
                            utils.get_input_media_from_file_id(i.cover, FileType.PHOTO)
                        ).id
                ...
                msg = f"{i.__class__.__name__} is not a supported type for send_paid_media"
                raise ValueError(msg)

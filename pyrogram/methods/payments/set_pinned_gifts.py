    ...
    async def set_pinned_gifts(
        ...
        Parameters:
            ...
            owned_gift_ids (List of ``str``):
                ...
                For an upgraded gift, you can use the gift link.
        ...
        Example:
            .. code-block:: python
                ...
                await app.set_pinned_gifts(owner_id="me", owned_gift_ids=["123", "456"])

                # Set pinned gifts in channel
                await app.set_pinned_gifts(owner_id="pyrogram", owned_gift_ids=["-1001292933413_123", "-1001292933413_456"])
        """
        await self.invoke(

    ...
    async def set_global_privacy_settings(
        ...
        Parameters:
            ...
            keep_chats_from_folders_archived (``bool``, *optional*):
                Whether unmuted chats, that are always included or pinned in a folder, will be kept in
                the Archive chat list when they get a new message.
                Ignored if keep_unmuted_chats_archived is set.
            ...
            show_gift_button (``bool``, *optional*):
                True, if a button for sending a gift to the user or by the user must be always shown.

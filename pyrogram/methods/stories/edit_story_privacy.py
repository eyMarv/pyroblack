...
class EditStoryPrivacy:
    async def edit_story_privacy(
        ...
        elif privacy == enums.StoriesPrivacyRules.PRIVATE:
            privacy_rules.append(raw.types.InputPrivacyValueDisallowAll())
        elif privacy == enums.StoriesPrivacyRules.NO_CONTACTS:
            privacy_rules.append(raw.types.InputPrivacyValueDisallowContacts())

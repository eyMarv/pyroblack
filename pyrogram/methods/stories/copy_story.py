...
class CopyStory:
    async def copy_story(
        ...
        Re-downloads a story and re-uploads it as a new story (a true copy, breaking
        the forward link), as opposed to forwarding by reference.
        ...
        Parameters:
            ...
            story_id (``int``):
                Story identifier in the chat specified in *from_chat_id*.

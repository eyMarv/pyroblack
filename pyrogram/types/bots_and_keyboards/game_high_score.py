...
class GameHighScore(Object):
    ...
    @staticmethod
    def _parse(
        client, game_high_score: raw.functions.HighScore, users: Dict[int, "raw.functions.User"]
    ) -> "GameHighScore":
    ...
    @staticmethod
    def _parse_action(
        client, service: raw.functions.MessageService, users: Dict[int, "raw.functions.User"]
    ) -> "GameHighScore":
        return GameHighScore(
